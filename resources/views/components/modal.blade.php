...
<div id="{{$id}}"
    ...
    <div x-show="show" x-transition:enter="ease-out duration-300"
         ...
         class="mb-6 bg-zinc-900 p-6 rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto relative border border-zinc-600">
