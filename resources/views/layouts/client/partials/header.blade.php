<header @click.away="sidebar=false" class="sticky top-0 shadow-lg z-50 transition-transform duration-300 ease-in-out" id="headerSite">
    <div
        class="bg-zinc-900/85 backdrop-blur-lg grid grid-cols-2 lg:grid-cols-12 items-center border-b border-zinc-600 px-3 z-30 w-full">
        <div class="lg:col-span-3">
            <a href="/" class="inline-flex items-center justify-start gap-1 p-1">
                ...
                <span class="hidden md:block lg:hidden xl:block font-bold min-w-fit w-fit h1 mb-0">
                    {{__(config('app.name'))}}
                </span>
            </a>
        </div>
...
{{--                <i class="tkicon stroke-zinc-200 fill-none" data-icon="magnifier"></i>--}}
{{--            </button>--}}
