            ...
            <x-lareon::table :headers="['id'=>'#','form_id'=>__('form'),'created_at'=>__('created at'),'deleted_at'=>__('deleted at'),]">
                ...
                @foreach($inboxes as $key=>$inbox)
                    <tr>
                        ...
                        <td>
                            <div class="action">
                                <x-lareon::link.restore :href="route('admin.questionnaire.inboxes.trash.reinstate' , $inbox->id)" can="admin.questionnaire.inbox.trash"/>
                                <x-lareon::link.delete :href="route('admin.questionnaire.inboxes.trash.prune' , $inbox->id)" can="admin.questionnaire.inbox.trash"/>
                            </div>
                        </td>
                    </tr>
                @endforeach
