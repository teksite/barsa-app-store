    ...
    private function addToSeoModel($instance, $data): void
    {
        ...
        $instance->seo()->updateOrCreate(
            ...
            [
                ...
                'indexable' => isset($data['meta']['indexable']) ? IndexableEnum::INDEX->value : IndexableEnum::NOINDEX->value,
                'followable' => isset($data['meta']['followable']) ? FollowableEnum::FOLLOW->value :  FollowableEnum::NOFOLLOW->value,
