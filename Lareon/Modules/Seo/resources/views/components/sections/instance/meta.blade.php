    ...
    <fieldset class="fieldset">
       ...
       <div class="mb-6">
        ...
        <div class="mb-6 flex items-center justify-start gap-3">
            <x-lareon::input.checkbox
                id="seo[meta][indexable]"
                name="seo[meta][indexable]"
                value="{{ \Lareon\Modules\Seo\App\Enums\IndexableEnum::INDEX->value }}"
                :checked="(old('seo.meta.indexable', $data['indexable'] ?? \Lareon\Modules\Seo\App\Enums\IndexableEnum::INDEX->value) == \Lareon\Modules\Seo\App\Enums\IndexableEnum::INDEX->value)"
            />
        ...
        <div class="mb-6 flex items-center justify-start gap-3">
            <x-lareon::input.checkbox
                id="seo[meta][followable]"
                name="seo[meta][followable]"
                value="{{ \Lareon\Modules\Seo\App\Enums\FollowableEnum::FOLLOW->value }}"
                :checked="(old('seo.meta.followable', $data['followable'] ?? \Lareon\Modules\Seo\App\Enums\FollowableEnum::FOLLOW->value) == \Lareon\Modules\Seo\App\Enums\FollowableEnum::FOLLOW->value)"
            />
