...
namespace Lareon\Modules\Product\App\Http\Controllers\Web\Panel\Versions;

use Illuminate\Http\Request;
use Illuminate\Routing\Controllers\HasMiddleware;
use Illuminate\Routing\Controllers\Middleware;
use Lareon\Modules\Product\App\Http\Controllers\Controller;
use Lareon\Modules\Product\App\Http\Requests\Panel\NewProductVersionRequest;
use Lareon\Modules\Product\App\Http\Requests\Panel\UpdateProductVersionRequest;
...
class ProductVersionsController extends Controller implements HasMiddleware
{
    ...
    public static function middleware(): array
    {
        return [
            ...
            new Middleware('can:panel.product.edit', except: ['index']),
        ];
    }
    ...
    public function index(Product $product)
    {
        ...
        return view('product::panel.pages.versions.index', compact('product' ,'versions'));
    }
    ...
    {
        return view('product::panel.pages.versions.create', compact('product'));
    }
    ...
    public function store(NewProductVersionRequest $request , Product $product)
    {
        ...
        return WebResponse::byResult($version, route('panel.products.versions.edit' , [$product,$version->result]))->go();
    }
    ...
    {
        return view('product::panel.pages.versions.edit', compact('product' ,'version'));
    }
    ...
    public function update(UpdateProductVersionRequest $request, Product $product ,  Version $version)
    {
        ...
        return WebResponse::byResult($res, route('panel.products.versions.edit', [$product, $version]))->go();
    }
    ...
    public function destroy(Product $product,  Version $version)
    {
        ...
        return WebResponse::byResult($res, route('panel.products.versions.index' , $product))->go();
    }
}
