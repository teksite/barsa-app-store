...
use Lareon\Modules\Skill\App\Models\Skill;
...
class UpdateUserRequest extends FormRequest
{
    ...
    {
        return collect(User::rules())->merge( SeoSitemap::rulesForModels())->merge( SeoModel::rulesForModels())->merge(Skill::rulesForModels())->merge([
            ...
            return true;
        })->when(auth()->id() != $this->user->id , function ($col){
            $col->merge([
