...
class UserMetaLogic
{
     ...
     */
    public function get(User|Authenticatable $user, array|string $keys = '*', array|String $columns = ['*']): ServiceResult
    {
        return app(ServiceWrapper::class)(function () use ($columns, $keys, $user) {
            return app(FetchDataService::class)(fn () => $user->getMetaArray($keys  , $columns));
        });
    }
