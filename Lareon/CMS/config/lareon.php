...
return [
    ...
    */
    'comment' => [
        ...
        'unconfirmed_visibility' => true, // user can see her/his unconfirmed comments in related page
        'limit' => 5,
        'notifyEmail' => [
            'sina.zangiband@gmail.com'
        ],
        'delete'=>1440, //after this time user can delete the comment
        'edit'=>1440 ,//after this time user can edit the comment
